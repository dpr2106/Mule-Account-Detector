  ...
  if (!isOpen) {
    return (
      <button 
        ...
        className="fixed bottom-6 right-6 bg-cyan-600 hover:bg-cyan-700 text-white rounded-full p-4 shadow-lg shadow-cyan-500/30 transition-transform hover:scale-105 z-50 flex items-center gap-2"
      >
