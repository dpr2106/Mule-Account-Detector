...
export default function ThreatGlobe() {
  ...
  return (
    <div className="w-full h-[400px] bg-black rounded-xl overflow-hidden border border-zinc-800/50 relative flex items-center justify-center">
      {/* Absolute overlay for styling */}
      <div className="absolute top-4 left-4 z-10 pointer-events-none">
        <h3 className="text-zinc-200 font-semibold text-sm uppercase tracking-wider">Global Threat Map</h3>
      ...
      <div className="absolute bottom-4 right-4 z-10 pointer-events-none text-right">
         <p className="text-xs text-zinc-400">Only displaying flagged transactions (Risk &gt; 85%)</p>
      </div>
