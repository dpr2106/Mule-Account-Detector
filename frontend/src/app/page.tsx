            ...
            <div className="flex-1 bg-zinc-900/80 rounded-xl border border-zinc-800 p-8 shadow-2xl relative overflow-hidden">
              ...
              {!selectedTx ? (
                ...
                <div className="animate-in fade-in duration-300 h-full flex flex-col">
                  <div className="flex justify-between items-start mb-8">
                    <div>
                      <h3 className="text-2xl font-bold text-white mb-2 flex items-center gap-3">
                        ...
                        {selectedTx.isMule && (
                          <span className="bg-pink-600 text-white text-xs px-2 py-1 rounded uppercase tracking-wider animate-pulse">
                            Critical Alert
                          </span>
                        )}
                      </h3>
                  ...
                  {selectedTx.isMule && (
                    <>
                      <div className="mt-auto bg-pink-500/10 border border-pink-500/30 p-6 rounded-lg">
              ...
              <tbody>
                {transactions.filter(t => t.score > 85).map(tx => (
                  <tr key={tx.id} className="border-b border-zinc-800/50 hover:bg-zinc-800/20">
                    ...
                    <td className="p-4">
                      <span className="bg-pink-500/20 text-pink-400 px-2 py-1 rounded font-bold">{tx.score}%</span>
                    </td>
                    <td className="p-4 flex gap-2">
                      <button className="bg-pink-600 hover:bg-pink-700 text-white px-3 py-1 rounded transition-colors">Freeze</button>
                      <button className="bg-zinc-700 hover:bg-zinc-500 text-white px-3 py-1 rounded transition-colors">Dismiss</button>
                    </td>
                  </tr>
                ))}
